...
function run(
    ...
    states, rates, propensities = MicrobePlasmidABM.System1.initialize_system(t, params)    
...
function update_rates!(
    ...
    rates.death_rates = MicrobePlasmidABM.System1.update_background_death(
        time, 
        states,
        params.death_rate,
