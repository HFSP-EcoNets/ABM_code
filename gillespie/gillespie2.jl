#= Implementation of the Gillespie algorithm for agent-based model, using strain-specific carrying capacity K_i and competition matrix A =#
#/ Start module
module Gillespie2
...
function run(
    ...
    states, rates, propensities = MicrobePlasmidABM.System2.initialize_system(t, params)    
...
function update_rates!(
    ...
    rates.death_rates = MicrobePlasmidABM.System2.update_background_death(
        time, 
        states,
        params.death_rate,
    ...
    for k in affected_subpopulations
      ...
      # rates.infection_rates = MicrobePlasmidABM.System2.update_infection_rate(states, params, new_abundances)
